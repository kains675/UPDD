...
NCAA_REGISTRY_DATA = [
    ...
    NCAADef(
        ...
        element="F",
        formal_charge=0,
        charge_model_note="Neutral backbone. Para-fluorinated Phe: F on CZ.",
        smiles_free="N[C@@H](Cc1ccc(F)cc1)C(=O)O",
        smiles_capped="CC(=O)N[C@@H](Cc1ccc(F)cc1)C(=O)NC",
        mutation_type="STANDARD",
        keep_atoms=("N", "CA", "C", "O", "CB", "CG", "CD1", "CD2",
                    "CE1", "CE2", "CZ", "FZ"),
        parent_residue="PHE",
        extension_atoms=(("FZ", "F", "CZ", 1.354),),
    ...
    NCAADef(
        ...
        element="Cl",
        formal_charge=0,
        charge_model_note="Neutral backbone. Para-Cl on CZ.",
        ...
        keep_atoms=("N", "CA", "C", "O", "CB", "CG", "CD1", "CD2",
                    "CE1", "CE2", "CZ", "CLZ"),
        parent_residue="PHE",
        extension_atoms=(("CLZ", "Cl", "CZ", 1.74),),
    ...
    NCAADef(
        ...
        element="Br",
        formal_charge=0,
        charge_model_note="Neutral backbone. Para-Br on CZ.",
        ...
        keep_atoms=("N", "CA", "C", "O", "CB", "CG", "CD1", "CD2",
                    "CE1", "CE2", "CZ", "BRZ"),
        parent_residue="PHE",
        extension_atoms=(("BRZ", "Br", "CZ", 1.88),),
    ...
    NCAADef(
        ...
        element="C",
        formal_charge=0,
        charge_model_note="Neutral backbone (D-isomer). Heavy atoms identical to L-Phe.",
    ...
    NCAADef(
        ...
        element="C",
        formal_charge=0,
        charge_model_note="Neutral backbone (D-isomer). Heavy atoms identical to L-Ala.",
    ...
    NCAADef(
        ...
        mutation_type="STANDARD",
        keep_atoms=("N", "CA", "C", "O", "CB", "CG", "CD1", "CD2", "CM"),
        parent_residue="LEU",
        extension_atoms=(("CM", "C", "N", 1.47),),  # Nα-methyl
    ...
    NCAADef(
        ...
        mutation_type="STANDARD",
        keep_atoms=("N", "CA", "C", "O", "CB", "CG1", "CG2", "CM"),
        parent_residue="VAL",
        extension_atoms=(("CM", "C", "N", 1.47),),
    ...
    NCAADef(
        ...
        mutation_type="STANDARD",
        keep_atoms=("N", "CA", "C", "O", "CB", "CG", "CD1", "CD2", "CE1", "CE2", "CZ", "CM"),
        parent_residue="PHE",
        extension_atoms=(("CM", "C", "N", 1.47),),
    ...
    NCAADef(
        ...
        mutation_type="STANDARD",
        keep_atoms=("N", "CA", "C", "O", "CB", "CG", "CD", "CE", "NZ", "CM"),
        parent_residue="LYS",
        extension_atoms=(("CM", "C", "N", 1.47),),
    ...
    NCAADef(
        ...
        mutation_type="STANDARD",
        keep_atoms=("N", "CA", "C", "O", "CB", "CG", "CD", "NE", "CZ", "NH1", "NH2", "CM"),
        parent_residue="ARG",
        extension_atoms=(("CM", "C", "N", 1.47),),
    ...
    NCAADef(
        ...
        mutation_type="STANDARD",
        keep_atoms=("N", "CA", "C", "O", "CB", "CG", "CD", "OE1", "NE2", "CM"),
        parent_residue="GLN",
        extension_atoms=(("CM", "C", "N", 1.47),),
    ...
    NCAADef(
        ...
        element="C",
        formal_charge=0,
        charge_model_note="Neutral backbone (D-isomer). Heavy atoms identical to L-Val; only CA chirality inverted.",
        smiles_free="N[C@H](C(C)C)C(=O)O",
        smiles_capped="CC(=O)N[C@H](C(C)C)C(=O)NC",
        mutation_type="STANDARD",
        keep_atoms=("N", "CA", "C", "O", "CB", "CG1", "CG2"),
        parent_residue="VAL",
    ...
    NCAADef(
        ...
        mutation_type="STANDARD",
        keep_atoms=("N", "CA", "C", "O", "CB", "CG", "CD", "NE", "CZ", "NH1", "NH2"),
        parent_residue="ARG",
    ...
    NCAADef(
        ...
        element="C",
        formal_charge=0,
        charge_model_note="Neutral backbone (D-isomer). Heavy atoms identical to L-Tyr.",
        smiles_free="N[C@H](Cc1ccc(O)cc1)C(=O)O",
        smiles_capped="CC(=O)N[C@H](Cc1ccc(O)cc1)C(=O)NC",
        mutation_type="STANDARD",
        keep_atoms=("N", "CA", "C", "O", "CB", "CG", "CD1", "CD2",
                    "CE1", "CE2", "CZ", "OH"),
        parent_residue="TYR",
        aliases=("dty", "d-tyrosine", "d-tyr"),
    ),
    NCAADef(
        label="D-Proline",
        code="DPR",
    ...
    NCAADef(
        ...
        mutation_type="STANDARD",
        keep_atoms=("N", "CA", "C", "O", "CB", "CG", "CD", "OD1"),
        parent_residue="PRO",
        extension_atoms=(("OD1", "O", "CG", 1.43),),
    ...
    NCAADef(
        ...
        charge_model_note="Fully-saturated Phe isostere (phenyl → cyclohexyl). Hydrophobic, achiral side-chain. "
                          "Heavy-atom graph identical to Phe (CB-CG-CD1/CD2-CE1/CE2-CZ 6-ring).",
        smiles_free="N[C@@H](CC1CCCCC1)C(=O)O",
        smiles_capped="CC(=O)N[C@@H](CC1CCCCC1)C(=O)NC",
        mutation_type="STANDARD",
        keep_atoms=("N", "CA", "C", "O", "CB", "CG", "CD1", "CD2", "CE1", "CE2", "CZ"),
        parent_residue="PHE",
    ...
    NCAADef(
        ...
        mutation_type="STANDARD",
        keep_atoms=("N", "CA", "C", "O", "CB", "OG1", "CG2",
                    "P", "O1P", "O2P", "O3P"),
        parent_residue="THR",
        extension_atoms=(
            ("P",   "P", "OG1", 1.60),
