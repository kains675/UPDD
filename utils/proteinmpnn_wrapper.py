...
# [SCRATCH] Route TMPDIR to dedicated SSD when available — ProteinMPNN emits
# sequence-design intermediates via tempfile.mkdtemp(prefix="mpnn_"). Silent
# fallback to /tmp when SSD absent.
